...
def get_classified_comments_postgres():
    query = "SELECT full_text, predicted_label, actual_label FROM tb_result;"
...
def evaluation_page():
    ...
    precision = precision_score(y_true, y_pred, pos_label='positif', average='binary')
    recall = recall_score(y_true, y_pred, pos_label='positif', average='binary')
    f1 = f1_score(y_true, y_pred, pos_label='positif', average='binary')
